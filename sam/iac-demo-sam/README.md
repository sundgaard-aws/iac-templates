...
```bash
iac-demo-sam$ sam logs -n StockCheckerFunction --stack-name iac-demo-sam --tail
```
...
```bash
iac-demo-sam$ dotnet test tests/StockChecker.Test
```
...
```bash
aws cloudformation delete-stack --stack-name iac-demo-sam
```
